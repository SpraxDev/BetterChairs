...
public class CustomArmorStand_15_R1 extends EntityArmorStand {
    ...
    public CustomArmorStand_15_R1(World world, double d0, double d1, double d2) {
    ...
    public static ArmorStand spawn(Location location, Player p) {
        ...
        CustomArmorStand_15_R1 customEntity = new CustomArmorStand_15_R1(mcWorld, location.getX(), location.getY(), location.getZ());
